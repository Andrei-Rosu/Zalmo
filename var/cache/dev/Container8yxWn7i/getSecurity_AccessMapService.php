...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/product'), array(0 => 'ROLE_USER'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/transaction'), array(0 => 'ROLE_CUSTOMER', 1 => 'ROLE_USER', 2 => 'ROLE_ADMIN'), NULL);
