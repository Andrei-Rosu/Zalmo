...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('Algolia\\SearchBundle\\Command\\SearchClearCommand' => function (): \Algolia\SearchBundle\Command\SearchClearCommand {
    return ($this->privates['Algolia\SearchBundle\Command\SearchClearCommand'] ?? $this->load(__DIR__.'/getSearchClearCommandService.php'));
}, 'Algolia\\SearchBundle\\Command\\SearchImportCommand' => function (): \Algolia\SearchBundle\Command\SearchImportCommand {
    return ($this->privates['Algolia\SearchBundle\Command\SearchImportCommand'] ?? $this->load(__DIR__.'/getSearchImportCommandService.php'));
}, 'Algolia\\SearchBundle\\Command\\SearchSettingsBackupCommand' => function (): \Algolia\SearchBundle\Command\SearchSettingsBackupCommand {
    return ($this->privates['Algolia\SearchBundle\Command\SearchSettingsBackupCommand'] ?? $this->load(__DIR__.'/getSearchSettingsBackupCommandService.php'));
}, 'Algolia\\SearchBundle\\Command\\SearchSettingsPushCommand' => function (): \Algolia\SearchBundle\Command\SearchSettingsPushCommand {
    return ($this->privates['Algolia\SearchBundle\Command\SearchSettingsPushCommand'] ?? $this->load(__DIR__.'/getSearchSettingsPushCommandService.php'));
