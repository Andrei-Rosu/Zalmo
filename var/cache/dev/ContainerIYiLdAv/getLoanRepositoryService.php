...
// Returns the private 'App\Repository\LoanRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LoanRepository.php';

return $this->privates['App\Repository\LoanRepository'] = new \App\Repository\LoanRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
